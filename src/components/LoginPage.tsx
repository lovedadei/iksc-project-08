...
const LoginPage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-green-700 relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-1/3 h-1/2 opacity-20">
          <img src="https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Forest background" className="w-full h-full object-cover rounded-br-3xl" />
        </div>
        <div className="absolute bottom-0 right-0 w-1/2 h-1/3 opacity-15">
          <img src="https://images.unsplash.com/photo-1518495973542-4542c06a5843?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Nature background" className="w-full h-full object-cover rounded-tl-3xl" />
        </div>
        <div className="absolute top-1/4 right-1/4 w-1/4 h-1/4 opacity-10">
          <img src="https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Pine trees" className="w-full h-full object-cover rounded-full" />
        </div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        ...
        <div className="flex justify-center items-center mb-8 space-x-8">
          <img src="/lovable-uploads/fbdff461-1ffb-485c-8e93-3141b2515bc0.png" alt="IKSC Logo" className="h-16 md:h-20 w-auto object-contain drop-shadow-lg" />
          <img src="/lovable-uploads/9c57fcd0-54f8-4f2a-8ff5-70b9175a0fb4.png" alt="KARE Logo" className="h-16 md:h-20 w-auto object-contain drop-shadow-lg" />
        </div>
        ...
        <Card className="w-full max-w-md shadow-2xl bg-white/95 backdrop-blur-sm border-0 transform transition-all duration-300 hover:scale-105">
          ...
          <CardContent className="p-8">
            <div className="space-y-6">
              ...
              <Button onClick={handleGoogleSignIn} disabled={isSigningIn} className="w-full py-4 text-lg font-semibold bg-white hover:bg-gray-50 text-gray-700 border-2 border-gray-300 hover:border-gray-400 transition-all duration-300 flex items-center justify-center space-x-3 shadow-lg hover:shadow-xl">
                {isSigningIn ? <>
